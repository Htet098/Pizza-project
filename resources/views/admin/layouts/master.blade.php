...
<body class="animsition">
    <div class="page-wrapper">
        ...
        <aside class="menu-sidebar d-none d-lg-block">
            <div class="logo">
                <a href="#">
                    <h4 class="text-primary text-shadow ">Pizza Order System</h4>
                    ...
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li>
                            <a href="{{ route('admin#contactList') }}">
                                <i class="fa-solid fa-envelope-open-text"></i>Contact</a>
                        </li>
                    </ul>
                </nav>
            </div>
                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="header-wrap">
                            ...
                            <h3 class="text-secondary">Admin Dashboard Panel</h3>
                                        ...
                                        <div class="account-dropdown js-dropdown">
                                            ...
                                            <div class="account-dropdown__footer my-3">
                                                <form action="{{ route('logout') }}" method="POST"
                                                    ...
                                                    @csrf
                                                    <button type="submit" class="btn btn-dark col-10">
