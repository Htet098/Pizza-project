                    ...
                    <tbody class="align-middle">
                        @foreach ($cartList as $c)
                            <tr>
                                ...
                                <td class="align-middle"><button class="btn btn-sm btn-danger removeBtn" id="removeBtn"><i
            ...
            <div class="col-lg-4">
                ...
                <div class="bg-light p-30 mb-5">
                    ...
                    <div class="pt-2">
                        ...
                        <button class="btn btn-block bg-primary text-white font-weight-bold my-3 py-3 "
